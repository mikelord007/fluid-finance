import FungibleTokenOption from "./FungibleTokenOption.cdc"
...
///
pub contract FungibleTokenOptionMetadataViews {
    ...
    pub struct FTVaultData {
        ...
        /// to store the funds.
        pub let createEmptyVault: ((): @FungibleTokenOption.Vault)
        ...
        init(
            ...
            createEmptyVaultFunction: ((): @FungibleTokenOption.Vault)
        ) {
            pre {
                receiverLinkedType.isSubtype(of: Type<&{FungibleTokenOption.Receiver}>()): "Receiver public type must include FungibleToken.Receiver."
                metadataLinkedType.isSubtype(of: Type<&{FungibleTokenOption.Balance, MetadataViews.Resolver}>()): "Metadata public type must include FungibleToken.Balance and MetadataViews.Resolver interfaces."
                providerLinkedType.isSubtype(of: Type<&{FungibleTokenOption.Provider}>()): "Provider type must include FungibleToken.Provider interface."
            }
